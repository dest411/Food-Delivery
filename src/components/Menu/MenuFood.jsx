...
const MenuFood = () => {
    ...
    return (
        <div className="mx-auto w-full max-w-[1500px] lg:mt-10 xl:mt-20">
            <h1
                className="mx-auto w-[90%] text-3xl font-bold sm:text-5xl md:text-3xl lg:mb-15 lg:text-4xl xl:text-5xl 2xl:text-6xl" //2xl:text-6xl
            >
                Popular {name}s of Naples
            </h1>
            <div className="mt-10 flex flex-col gap-10 sm:gap-20 md:gap-14 lg:gap-12 xl:mt-20 xl:gap-18 2xl:gap-20">
                            ...
                            <div className="mx-auto flex w-[90%] items-center">
                                <div className="relative flex h-auto w-full flex-col">
                                    {food.typePhoto == null ? (
                                        ...
                                        <img
                                            className={`absolute z-110 select-none ${
                                                activeMenu === 'Pizza'
                                                    ? 'top-[-30%] left-[-15px] h-40 w-40 sm:top-[-20%] sm:h-40 sm:w-40 md:top-[-25%] md:h-40 md:w-40 lg:top-[-25%] lg:h-50 lg:w-50 xl:top-[-35%] xl:h-70 xl:w-70 2xl:h-80 2xl:w-80' // 2xl 80
                                    ...
                                    <div className="bg-gray flex w-full items-center justify-between pr-3 pl-[30%] text-white 2xl:py-1">
                                        <h1
                                            className="text-xl sm:text-lg md:text-xl lg:text-2xl xl:text-4xl 2xl:text-5xl" // 2xl:text-5xl
                                        >
                                            {food.name}
                                        </h1>
                                        <h2 className="text-xl sm:text-lg md:text-xl lg:text-2xl xl:text-4xl 2xl:text-5xl">
                                            {food.price}$
                                        </h2>
                                    </div>

                                    <div
                                        className="flex h-18 w-full sm:h-20 md:h-20 lg:h-25 xl:h-32 2xl:h-35" //2xl:h-35
                                    >
                                        <div className="h-full w-[30%] bg-gray-100"></div>
                                        <ul className="relative grid h-full w-[70%] list-inside list-disc grid-flow-col grid-rows-3 bg-gray-100 p-2 text-[13px] sm:text-[18px] md:text-[15px] lg:text-[17px] xl:text-[23px] 2xl:text-[25px]">
